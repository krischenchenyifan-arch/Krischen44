...
print(f"Neuron 9 output is {Neuron.sigmoid(z9)}")
...
print(f"Neuron 10 output is {Neuron.sigmoid(z10)}")
...
print(f"Neuron 11 output is {Neuron.sigmoid(z11)}")
